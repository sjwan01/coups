...
1.  when and where it took place,
2.  the type of its initiator (e.g. military, rebels),
3.  the coup outcome (realized or not, or it is just a thwarted conspiracy),
4.  the fate of the deposed leader (e.g. jailed, fled).
...
2.  the regime characteristics,
3.  the electoral outcomes
