...
# Read datasets
main <- read_csv("/Users/shunji/Downloads/Coup data 2.1.2.csv")
reign <- read_csv("/Users/shunji/Downloads/REIGN_2021_8.csv")
...
joined <- joined %>%
  ...
  select(c("age", "tenure_months", "lastelection",
           "dem_duration", "political_violence",
